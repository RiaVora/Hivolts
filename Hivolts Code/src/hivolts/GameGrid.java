...
public class GameGrid extends JFrame {
	...
	//Runs when GameGrid is called as an initializing method
	public void init() {	
		
		//performs the initial functions
		reset();
...
//						//Horizontal < vertical, move vertical 
	...
	public void paint(Graphics g) {
		...
		//Presents the game over screen and resets the necessary variables after the user loses and alive is false
		gameOver(g);
		
		//Presents the you won screen and resets the necessary variables after the user wins and alive is true
		youWon(g);
	...
	public void gameOver(Graphics g){
		...
		if (alive == false) {
			...
			g.drawString("You died because " + dieReason, 175, 425);
			
			//Resets the necessary variable
			resetReady = true;
		}
	}
